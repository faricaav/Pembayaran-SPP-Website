<?php
    include "koneksi.php";
    $edit=mysqli_query($conn,"SELECT * FROM siswa,kelas,spp WHERE nisn='".$_GET['nisn']."'");
                ...
                <div class="card-body px-0 pb-2">
                  <form form action="" method="post" role="form" class="text-start">
                    <div class="input-group input-group-outline mb-3">
                      <input type="text" name="nisn" class="form-control" value="<?php echo $e['nisn'];?>">
                    </div>
                    <div class="input-group input-group-outline mb-3">
                      <input type="text" name="nis" class="form-control" value="<?php echo $e['nis'];?>">
                    </div>
                    <div class="input-group input-group-outline mb-3">
                    ...
                    <div class="input-group input-group-outline mb-3">
                      <input type="text" name="no_telp" class="form-control" value="<?php echo $e['no_telp'];?>">
                    </div>
...
<?php 
    ...
    $password=$_POST['password'];
      ...
      $update=mysqli_query($conn,"UPDATE siswa SET nisn='".$nisn."',nis='".$nis."',nama='".$nama."',id_kelas='".$id_kelas."',alamat='".$alamat."',no_telp='".$no_telp."',id_spp='".$id_spp."',username='".$username."',password='".MD5($password)."' WHERE nisn ='".$e['nisn']."'");
			if($update){
			    echo "<script>alert('Siswa berhasil terupdate');location.href='?siswa=read';</script>";
			} else {
		        echo "<script>alert('Gagal update siswa');location.href='?siswa=read';</script>";
			}
		}
	}
?>